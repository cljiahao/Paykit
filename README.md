...
own refund (`issueRefundAction`) is recorded too, it's now readable via the
`/admin/activity` tab (`@merqo/ui`'s shared `AuditLogTable` — see
`src/app/admin/activity/README.md`), and the table is
